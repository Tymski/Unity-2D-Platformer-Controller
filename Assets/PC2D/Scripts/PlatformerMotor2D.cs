...
public class PlatformerMotor2D : MonoBehaviour
{
    ...
    /// <summary>
    /// ËÄêÂäõÂÄº ,ËßíËâ≤ÁöÑÊØèÈ°πË°åÂä®ÈÉΩ‰ºöÊ∂àËÄóËÄêÂäõÂÄº
    /// </summary>
    ...
    /// <summary>
    /// ∞°∏∏»˜ ¡°«¡»ƒ ¿Ãµø¿Ã≥™ ¡°«¡¡ﬂ πÊ«‚ ¿¸»ØΩ√ xº”µµ 0ø°º≠ √÷¥Îº”µµ±Ó¡ˆ ∞°¥¬µ• ∞…∏Æ¥¬ Ω√∞£ ∫Øºˆ ///
    ...
    private void Awake()
    {
        // ∏ﬁ¿Œ»≠∏Èæ¿ø°º≠ ∑ŒµÂ ¥≠∑∂¿∏∏È ∫“∑Øø¬ ¿ßƒ°∑Œ «√∑π¿ÃæÓ ¿ßƒ°∫Ø∞Ê
    ...
    // ƒ›∂Û¿Ã¥ı ¡÷∫Ø ππ¿÷≥™ √º≈©«œ∞Ì ¿˙¿Â,∏Æ≈œ«œ¥¬ ∏ﬁº“µÂ
